# Generated by Powerlevel10k configuration wizard on 2020-11-26 at 14:21 CET.
...
() {
  ...
  typeset -g POWERLEVEL9K_KUBECONTEXT_CONTENT_EXPANSION='${P9K_KUBECONTEXT_NAME}/${P9K_KUBECONTEXT_NAMESPACE}'
  ...
  typeset -g POWERLEVEL9K_BATT
  CONNECTED_FOREGROUND=3
